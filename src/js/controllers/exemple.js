...
/* Controllers */
angular.module('app')
.controller('ExempleController', ExempleController);

	ExempleController.$inject = ['$scope', '$filter', '$timeout', 'exportSheetJs'];

	function ExempleController ($scope, $filter, $timeout, exportSheetJs) {
